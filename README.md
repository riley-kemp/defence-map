...
- [Canada_CD.geojson](data/Canada_CD.geojson) - is a GeoJSON containing spatial data of Canada, divided into national census divisions. This data is based off the [2025 Statistics Canada Census Subdivision Boundary File](https://www12.statcan.gc.ca/census-recensement/2011/geo/bound-limit/bound-limit-s-eng.cfm?year=25) and was aggregated by "CDUID". The GeoJSON has a CRS of EPSG:3347.
- [Canada_PR.geojson](data/Canada_PR.geojson) - is a GeoJSON containing spatial data of Canada, divided into provinces and territories. This data is based off the [2025 Statistics Canada Census Subdivision Boundary File](https://www12.statcan.gc.ca/census-recensement/2011/geo/bound-limit/bound-limit-s-eng.cfm?year=25) and was aggregated by "PRUID". The GeoJSON has a CRS of EPSG:3347.

## Map
Can be found [here.](https://defencemap.trilliummfg.ca/)

## Questions/Comments
Please [contact us.](https://trilliummfg.ca/contact-us/)
